...
class TestLinkTagFactoryInternalRelative(AbstractFakeDokuTest):
    def test_valid(self) -> None:
        ...
        self.assertEqual(LinkType.INTERNAL_RELATIVE, link_tag.link_type)
    ...
    def __get_values(self) -> dict[str, str | None]:
        core: str = "~relative:namespace:page"
