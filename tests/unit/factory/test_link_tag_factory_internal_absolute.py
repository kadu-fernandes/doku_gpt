...
class TestLinkTagFactoryInternalAbsolute(AbstractFakeDokuTest):
    def test_valid(self) -> None:
        ...
        self.assertEqual(LinkType.INTERNAL_ABSOLUTE, link_tag.link_type)
    ...
    def __get_values(self) -> dict[str, str | None]:
        core: str = ":some:absolute:namespace:page"
        label: str = "This is a namespace"
