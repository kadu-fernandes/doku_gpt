...
class TestUnderlineSanitizer(unittest.TestCase):
    ...
    LINE = "DokuWiki supports **bold**, //italic//, underlined and ''monospaced'' texts. But, of course you can **//''combine''//** all these. You can use <sub>subscript</sub>, <sup>superscript</sup>, and <del>deleted</del> as well."

    def test_sanitize(self) -> None:
        self.assertEqual(self.LINE, UnderlineSanitizer.sanitize(self.TO_SANITIZE))
